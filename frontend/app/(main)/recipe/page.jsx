    ...
    return (
      <div className="min-h-screen bg-stone-50 pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl text-center py-20">
          ...
          <p className="text-stone-900 mb-6 font-light">
              ...
              {recipe.nutrition && (
                <div className="mt-6 pt-6 border-t-2 border-stone-200">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-orange-50 p-3 text-center border-2 border-orange-100 overflow-hidden">
                      <div className="text-2xl font-bold text-orange-600 wrap-break-words">
                        {recipe.nutrition.calories}
                      </div>
                    ...
                    <div className="bg-stone-50 p-3 text-center border-2 border-stone-100 overflow-hidden">
                      <div className="text-2xl font-bold text-stone-900 wrap-break-words">
